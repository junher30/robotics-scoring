...
export const resultsSchema=z.object({
 events:z.array(z.object({id,name:z.string(),city:z.string().nullable(),status:z.enum(['ACTIVE','FINISHED']),description:z.string().nullable(),logo_url:z.string().nullable()})),
