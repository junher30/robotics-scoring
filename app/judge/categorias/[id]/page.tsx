...
import {byTeamNumber,matchesTeamQuery} from '../../../../lib/scoring/search';
...
export default async function Page({params,searchParams}:{params:Promise<{id:string}>;searchParams:Promise<{q?:string;pagina?:string}>}){
 ...
 const teams=data.teams.filter(t=>matchesTeamQuery(t,q)).sort(byTeamNumber);
